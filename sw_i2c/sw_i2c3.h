#ifndef DEF_SW_I2C3_H_
#define DEF_SW_I2C3_H_
#include "VXIS_Extern_Define.h"

extern void SW_I2C3_Init(void);
extern void I2C3_Write(uint8_t chipID, uint8_t reg, uint8_t val);
extern void I2C3_WriteNByte(uint8_t chipID, WORD reg, uint8_t *ptr, uint8_t NByte);
extern uint8_t I2C3_Read(uint8_t chipID, uint8_t reg);
